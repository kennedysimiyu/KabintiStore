// modelling the products for our application
package kennedysimiyu.com.KabintiStore.models;
...
/**
 * implementing parcelable because we will be sending products to objects using bundles
 */
...
public class Product implements Parcelable{
    ...
    // checks to see if the sale price is greater that 0 if true retruns true otherwise retutns false
    ...
    // method returning the number of ratings as a string and surrounding it with brackets
